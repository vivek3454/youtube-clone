  ...
  return (
    <div className="flex justify-center flex-row h-[calc(100%-56px)] bg-black">
      <div className="w-full max-w-[1400px] flex flex-col lg:flex-row">
        <div className="flex flex-col sticky bg-black top-[43px] z-[100] lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          ...
          <div className="text-white z-20 font-bold text-sm md:text-xl mt-4 line-clamp-2">
            {video?.title}
          </div>
